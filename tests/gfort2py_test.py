...
class TestStringMethods(unittest.TestCase):
	...
	def test_a_str(self):
		v='123456798'
		x.a_str=v
		self.assertEqual(x.a_str,v.encode())
	...
	def test_a_str_short_length(self):
		v='1324'
		x.a_str=v
		self.assertEqual(x.a_str,v.encode())
	...
	def test_a_str_point(self):
		v='abcdefghij'
		x.a_str_point=v
		self.assertEqual(x.a_str_point,v.encode())
	...
	def test_a_str_target(self):
		v='abcdefghij'
		x.a_str_target=v
		self.assertEqual(x.a_str_target,v.encode())
	...
	def test_sub_alter_mod(self):
		...
		self.assertEqual(x.a_str,"9999999999".encode())
